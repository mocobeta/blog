...
以降の内容は完全に勘違いで，コードのバグでトリアージエージェントが初回しか呼ばれていないだけでした。トリアージエージェントとサブエージェントの協調動作の様子は[Agents SDKのエージェントオーケストレーションパターン - Handoffs (Take 2)](https://blog.mocobeta.dev/posts/20251212-agents-handoffs-2/)に改めてまとめました。😅
